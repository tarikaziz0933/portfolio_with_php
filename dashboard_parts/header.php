<?php
    ...
    //print_r($after_assoc_select_profile_info);
?>
...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            <a href="/portfolio/dashboard/dashboard.php" class="sl-menu-link">
            ...
            <nav class="nav">
                <div class="dropdown">
                    <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                        <span class="logged-name"><?= $after_assoc_select_profile_info['name']?></span></span>
                        <img src="/portfolio/uploads/users/<?= $after_assoc_select_profile_info['profile_picture']?>"
                            class="wd-32 rounded-circle" alt="">
                    </a>
                    <div class="dropdown-menu dropdown-menu-header wd-200">
                        <ul class="list-unstyled user-profile-nav">
                            <li><a href="/portfolio/users/edit_profile.php"><i class="icon ion-ios-person-outline"></i>
                                    Edit Profile</a></li>
